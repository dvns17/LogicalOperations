...
# )Correct:3**2 == 3+6 or 1+2<=3 and True

#3)
# )Broken: Change it so it returns False
# )(True and False) or (True or false)
# )Correct:(true and False) or (True and False)

#4)
# )Broken: Make the code return True
# )((5==5) and 4<3) and not(True and 8**2 >= 64)
# )Correct: ((5==5) and 4>3) and (True and 8**2 >= 64)
...
# )Correct:((a or b) and a) or (a and b)
